...
LOCAL_FILE_URL = "file:///C:/Users/cetin/Desktop/WebTools/LineHexagonPerspective.html" # EXAMPLE: "file:///C:/Games/Hexagon/game.html"

# 2. Other settings
NUM_QUESTIONS = 1
SAVE_DIR = "C:/Users/cetin/Desktop/LineHexagonPerspective" # Directory to save images
...
for i in range(1, NUM_QUESTIONS + 1):
    ...
    # --- Question Image ---
    # The question is the main canvas with the 3D prism.
    question_path = os.path.join(SAVE_DIR, f"question_{i}.png")
    question_elem = driver.find_element(By.ID, "prismCanvas")
    question_elem.screenshot(question_path)
    resize_image(question_path, (400, 400))
    print("👍 Question screenshot taken.")

    # --- Answer Choices ---
    # The choices are canvas elements with the class 'option'.
    ...
    if i < NUM_QUESTIONS:
        ...
        driver.refresh()
        time.sleep(1) # Wait for the new game to load
