...
# === CONFIGURATION ===
NUM_QUESTIONS = 1
SAVE_DIR = "C:/Users/cetin/Desktop/TopViewCubeQuestions" # Kaydedilecek klasör
...
for i in range(1, NUM_QUESTIONS + 1):
    ...
    # --- Soru görüntüsü ---
    # Soru, id="mainCanvas" olan ana çizim alanıdır.
    ...
    options_elements = driver.find_elements(By.CLASS_NAME, "optionCanvas")
    option_paths = []
